...
#ifndef __RTS2_RTS2CONN__
#define __RTS2_RTS2CONN__
...
/**
 * Represents one RTS2 connection. It keeps connection running, check it states, and
 ...
 * @ingroup RTS2Block
 */
class Rts2Connection:public Connection
{
	public:
		Rts2Connection (Block * in_master);
		Rts2Connection (int in_sock, Block * in_master);
		virtual ~ Rts2Connection (void);
		...
		virtual void updateStatusWait (Rts2Connection * conn);
