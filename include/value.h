...
class Value
{
	...
	protected:
		...
		{
			rts2Type |= (RTS2_TYPE_MASK | RTS2_VWHEN_MASK | RTS2_VWHEN_RECORD_CHANGE | RTS2_VALUE_DEVPREFIX | RTS2_FITS_HEADERS | RTS2_VALUE_WRITABLE | RTS2_VALUE_NOTNULL | RTS2_VALUE_ERRORMASK) & flags;
		}
