...
class Value
{
	public:
		 ...
		 */
		virtual int setValue (Rts2Connection * connection) = 0;
		 ...
		 * @return -1 on error, 0 on success.
		 */
		int sendMetaInfo (Rts2Connection * connection);
	...
	protected:
		 ...
		 */
		virtual int sendTypeMetaInfo (Rts2Connection * connection);
...
class ValueSelection:public ValueInteger
{
	public:
		...
		int sendSelections (Rts2Connection *connection);
