...
#ifndef __RTS2__SIMBADTARGETDB__
#define __RTS2__SIMBADTARGETDB__
 ...
 */
class SimbadTargetDb: public ConstTarget, public rts2core::SimbadTarget
{
	public:
		SimbadTargetDb (const char *in_name);
		virtual ~SimbadTargetDb (void);
...
#endif // !__RTS2__SIMBADTARGETDB__
