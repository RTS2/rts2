...
Pøesnou strukturu datábaze - zvlá¹tì pak datové typy jednotlivých polo¾ek - je
...
pole jsou pak znaèeny pomocí $\cross$.
...
{\bf tar\_lastobs}	& datum posledního pozorování cíle
\end{tabular}
...
\begin{tabular}{ll}
{\bf $\cross$ tar\_id}	& èíslo cíle \\
{\bf $\star$ obs\_id}	& èíslo pozorování \\
{\bf obs\_start}	& datum zahájení pozorování \\
{\bf obs\_duration}	& délka trvání pozorování \\
{\bf obs\_imagescount}	& poèet napozorovaných snímkù
\end{tabular}
...
{\bf img\_date}		& datum poøízení snímku \\
...
{\bf $\cross$ obs\_id}	& èíslo pozorování \\
{\bf camera\_name}	& jméno kamery \\
{\bf mount\_name}	& jméno montá¾e \\
{\bf epoch\_id}		& èíslo epochy \\
{\bf media\_id}		& médium, na kterém je snímek umístnìn
\end{tabular}
...
{\bf dark\_date}	& datum poøízení snímku \\
...
\begin{tabular}{ll}
{\bf $\cross$ tar\_id}	& èíslo pozorování \\
{\bf $\star$ grb\_id}	& èíslo GRB \\
{\bf grb\_seqn}		& aktální èíslo poøadí zprávy \\
