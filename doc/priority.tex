...
V systému RTS2 se pou¾ívá exkluzivního pøístupu k~exekuèním funkcím -
pouze jeden klient mù¾e volat exekuèní funkce, ostatní klienti pøi
volání exekuèní funkce obdr¾í chybovou zprávu, oznamující, ¾e funkci
...
libovolnì vyberu jednoho z nich
\end{itemize}

Klient s~pøístupem k~exekuèním funkcím je mù¾e vykonávat, ostatní
klienti obdr¾í pøi volání exekuèním funkcí chybovou hlá¹ku.
...
nárùstu slo¾itosti kódu bych získal nìco málo èasu. Viz diagram
\ref{fig:kill-nextexe}.
...
Motivace implementace tohoto pøípadu spoèívá v~mo¾nosti nechat
...
Dal¹í zajímavou mo¾ností je do vyètení kamery v~prùbìhu pøesunu
...
pøítomnost klientu s~vy¹¹í prioritu. Je znázornìn na diagramu
\ref{fig:kill-waitexe}.
...
\item Pou¾ijeme priorit. Do plánovaèe zabudujeme bloky.

\item Priorita se bude mìnit buïto okam¾itì (vhodné pro GRB), nebo s
èekáním do ukonèení bloku (vhodné pro dlouhodobý plánovaè).

\item Zaøízení vìdí, jaký klient má u~nich nejvìt¹í prioritu. Ze serveru jim
