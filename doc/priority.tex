...
Z~hlediska priorit je mo¾né v¹echny funkce, které mù¾e proces vykonávat,
...
\item pokud má dva nebo více klientù stejnou prioritu, klient, který má
...
prioritu pod hodnotu nìkterých jiných procesù.
...
První øe¹ení nepøiná¹í, hlavnì ve srovnání s~dal¹ími, ¾ádné výhody. V
náhodných pøípadech se podaøí pozorovaní dokonèit, v ostatních pouze ztratíme
èas.

Druhý pøípad mù¾e také vést ke ztrátì èasu - napøíklad tím, expozice dobìhne,
nezíská systém ¾ádný pou¾itelný výsledek, jeliko¾ naexponovaný snímek nebude
vyèten - zabrání v~tom pøítomnost klientu s~vy¹¹í prioritu. Toto je znázornìno
na diagramu \ref{fig:kill-waitexe}.
...
\item Pou¾ijeme priorit. Komunikace mezi klienty a zaøízenímy obsahuje
pøíkazy pro zahájní a ukonèení bloku.

\item Priorita se mìní buïto okam¾itì (vhodné pro GRB), nebo s
èekáním do ukonèení bloku (vhodné pro dlouhodobý plánovaè).

\item ®ádost o prioritu je pøedávána na centrální server, který ji distribuuje
zaøízením. Ty pak informují klienty o splnìní ¾ádosti. Bloky jsou pøedávány pøímo na zaøízení.

\end{itemize}

Problém dovyètení kamery a souzahájení pøesunu na novou pozici lze pak vyøe¹it
následovnì:

\begin{itemize}

\item kamera zahájí vyèítání

\item montá¾ ukonèí blok, priorita tak získá nový klient

\item nový klient provede pøesun montá¾e na novou pozici a bude èekat do
okam¾iku získání priority na kameøe

\item kamera ukonèí vyèítání, ukonèí blok, pøedá prioritu

\item nový klient zahájí vyèítání kamery
