...
Klientské procesy vystupují v protokolu v¾dy jako klienti. Zaøízení, na které
se pøipojují, jsou servery. 

Zaøízení vystupují pøi komunikaci s centrálním serverem jako klient. Pøi
komunikaci mezi zaøízeními se jedno zaøízení chová jako klient a druhé jako
server.
...
Textové rozhraní lze pøi pohledu zvenèí snadno pochopit. Je nároènìj¹í na
systémové prostøedky ne¾ binární komunikace - jsou pøená¹ena del¹í data,
pøijaté pøíkazy je tøeba pøed zpracováním detekovat.

Systém pou¾ívá pro pøenos pøíkazù a zpráv textové komunikace. Pro pøenos
binárních dat (snímkù) se pou¾ívá binárního formátu.

Bloky komunikace v textovém rozhraní jsou ukonèovány znaèkou konce øádky.
...
Zaèínají znakem 'S', obsahují název stavu, jeho novou hodnotu a doplòující
komentáø.
...
Zaèínají písmenem I. Po navázání spojení informují klienta o poètu a jménech
stavù serveru.
...
hodnoty lze nalézt v souboru include/status.h.
...
\comvalue{user}{[id] [priorita] [*|-] [jméno u¾ivatele] [popis provádìné èinnosti]}
...
\comret{DEVDEM\_E\_SYSTEM}{zaøízení neexistuje}
...
\comname{ready}{}{zjistí, zda je zaøízení pøipojeno. Je mo¾né volat
opakovanì.}
...
\comvalue{temperature\_regulation}{[0 | 1 | 2]}{stav chlazení kamery - chlazení vypnuto, chladím na maximální výkon, dr¾ím teplotu chlazení}
...
\comvalue{longtitude}{[zemìpisná délka]}{zemìpisná délka dalekohledu}
...
se pøipojuje jeden klient, který chce provádìt ostøení kamery. Po svém
