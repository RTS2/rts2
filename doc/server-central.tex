...
poèítaèe øídícího vyèítání. Je tedy vhodné mít minimálnì dvì, navzájem spojená
...
jednoúèelové procesy-agenty, které vykonávají svoji specifickou èinnost a
...
Pro komunikaci mezi jednotlivými agenty pou¾ijeme standardní dostupné
komunikaèní médium se známým protokolem. Umo¾níme tak pøípadné zapojení jiných
druhù zaøízení èi klientù.

\section{Centrální server}

Existují funkce systému, které je rozumné spravovat centrálnì. Jedná se v¾dy
o~funkce, které se na v¹ech zaøízeních chovají stejnì. Jako vhodný pøíklad mù¾e
poslou¾it autentifikace - pøi pou¾ití veøejného u¾ivatelského jména a~tajného
hesla je vhodné zajistit, aby klientovi staèilo jedno u¾ivatelské jméno a jedno
heslo. Dal¹ím pøíkladem mù¾e být seznam zaøízení obsa¾ených v systému. Tyto
funkce jsou dále oznaèovány jako {\bf centrální funkce}.

Funkce, které je tøeba volat na jednotlivých zaøízeních, jsou oznaèovány jako
{\bf lokální funkce}.
...
typu ST8, vybavené ¹irokoúhlou optikou. Na hlavním dalekohledu je pak umístìna
...
pro ¹irokoúhlé kamery a cnf1 pro kameru umístìnou v ohnisku dalekohledu.
...
pøípadnì jiných klientù, je tøeba na lascaux nastavit forwarding jednotlivých
TCP portù na poèítaèe ve vnitøní síti a v konfiguraèních souborech kamer je
tøeba zmìnit název poèítaèe}.
