...
\item[observing] pohyb montá¾e sleduje pohyb hvìzdné oblohy 

\item[moving] montá¾ nají¾dí na novou pozici
...
\item zjistíme orientaci dalekohledu $\vec{a_2}$, získáme snímek $img_2$
...
V tomto okam¾iku je tøeba zmìnit hodnoty èítaèe o $\vec{\delta_2}$ -
$\vec{\delta_1}$. V pøípadì, ¾e je aktuálnì exponován snímek $m$, je
tøeba zmìnit èítaèe pøi pøíchodu korekce spoèítané ze snímku $a$ o 
...
expozici. Úkolem montá¾e není hlídat, co kamery na ní umístìné vykonávají.
