...
START_TEST(message_format)
{
	...
	ck_assert_str_eq ("moving from 00:49:21.600 +056 06 00.00 (altaz +012 21 00.00 +085 13 48.00) to 00:41:19.200 -056 06 00.00 (altaz +270 21 36.00 -080 12 00.00", m1.expandString ("moving from $h0 $d1 (altaz $d4 $d5) to $h2 $d3 (altaz $d6 $d7").c_str ());
}
END_TEST
