...
CC_QUERY_TEMPERATURE_STATUS,
  CC_ACTIVATE_RELAY, CC_PULSE_OUT, 
...
CC_GET_TURBO_STATUS,
  CC_END_READOUT, CC_GET_US_TIMER, 
CC_OPEN_DEVICE, CC_CLOSE_DEVICE,
...
CC_SET_DRIVER_HANDLE, 
     ...
     */ 
    CC_SEND_BLOCK =
    90, CC_SEND_BYTE, CC_GET_BYTE, CC_SEND_AD, 
CC_GET_AD, CC_CLOCK_AD,
  CC_LAST_COMMAND
}
PAR_COMMAND;
...
CE_AD_TIMEOUT, CE_KBD_ESC,
  CE_CHECKSUM_ERROR, CE_EEPROM_ERROR, 
...
*/ 
  typedef enum
{ CS_IDLE, CS_IN_PROGRESS, CS_INTEGRATING, 
...
typedef enum
{ CCD_INFO_IMAGING, CCD_INFO_TRACKING, 
CCD_INFO_EXTENDED,
...
typedef enum
{ ST7_CAMERA =
    4, ST8_CAMERA, ST5C_CAMERA, TCE_CONTROLLER, 
ST237_CAMERA, STK_CAMERA,
...
typedef enum
{ REGULATION_OFF, REGULATION_ON, 
REGULATION_OVERRIDE, REGULATION_FREEZE,
  REGULATION_UNFREEZE, 
...
typedef enum
{ AOF_HARD_CENTER, AOF_SOFT_CENTER, AOF_STEP_IN, 
AOF_STEP_OUT
}
AO_FOCUS_COMMAND;
...
TCEC_TX_TO_EXP,
  TCEC_ENABLE_LIMIT, TCEC_SET_EXP_CONTROL, 
TCEC_GET_EXP_STATUS,
  TCEC_GET_RESULT_BUF, TCEC_LIMIT_STATUS, 
TCEC_WRITE_BLOCK,
  TCEC_READ_BLOCK, TCEC_GET_ROM_VERSION, 
TCEC_SET_COM_BAUD,
  TCEC_SET_MOTION_CONTROL, TCEC_GET_MOTION_CONTROL, 
TCEC_READ_THERMISTOR,
  TCEC_GET_MOTION_STATE, TCEC_SET_SIDEREAL_CLOCK, 
TCEC_GET_SIDEREAL_CLOCK,
  TCEC_LOOPBACK_EXP_TEST, TCEC_GET_KEY, 
TCEC_GET_KEYS,
  TCEC_GET_EEPROM_DATA, TCEC_GET_TCE_INFO, 
TCEC_SET_EEPROM_DATA,
  

TCEC_OPEN_DRIVER =
    0x50, TCEC_CLOSE_DRIVER, TCEC_GET_DRIVER_INFO, 
TCEC_ESTABLISH_LINK,
  TCEC_HARDWARE_RESET, 
     ...
     */ 
    TCEC_READ_EE_BLOCK =
    0x30, TCEC_WRITE_EE_BLOCK, TCEC_MICRO_OUT, 
TCEC_READ_R0, TCEC_WRITE_R0,
  TCEC_READ_GA, TCEC_WRITE_GA, 
TCEC_GET_EBS, 
...
*/ 
  typedef enum
{ MOVE_STOP, MOVE_BASE, MOVE_LEAVE, MOVE_0R5X, MOVE_1X, 
MOVE_2X, MOVE_4X,
  MOVE_8X, MOVE_16X, MOVE_32X, MOVE_64X, 
...
#define TCES_EXTENDED_ERROR	99	/* this indicates an extended error occured
  ...
  typedef enum
{ PS_UNPARKED, PS_PARKED, PS_UNPARKING, PS_PARKING, 
PS_PARK_LOST,
  PS_INITIALIZING,
}
TCES_PARK_STATUS;
...
*/ 
  typedef enum
{ TCEEE_NO_ERROR, TCEEE_LIMIT_HIT, TCEEE_USER_ABORT, 
TCEEE_RA_TIMEOUT,
  TCEEE_DEC_TIMEOUT, TCEEE_COM_MOTION_TIMEOUT, 
TCEEE_RA_COM_ERROR,
  TCEE_DEC_COM_ERROR
}
TCE_EXTENDED_ERRORS;
