...
const char *tableScript = "var sortcol = 0;\n"
"var asc = true;\n"
...
"function sort_str(a,b){\n"
  "var ret = (a[sortcol] < b[sortcol]) - (b[sortcol] < a[sortcol]);\n"
  "if (asc) return ret;\n"
    "else return -1 * ret;\n"
"}"

"function fillTD(td,row,header,i){\n"
  "switch(header.t){\n"
    "case 'r':\n"
...
"function fillTable(tab){\n"
  ...
  "}\n"
"}\n"
"function resortTable(tabid,col,sortfunc){\n"
