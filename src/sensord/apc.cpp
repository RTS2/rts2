...
/**
 * APC PDU driver. Allows controlling APC Power Distribution Units, such as:
 * http://www.apc.com/shop/us/en/products/Rack-PDU-Switched-1U-15A-100-120V-85-15/P-AP7900
 *
 * @author Petr Kubánek <petr@kubanek.net>
 */
class APC:public Sensor
{
	public:
...
APC::APC (int argc, char **argv):Sensor(argc, argv)
{
	host = NULL;

	addOption('s', NULL, 1, "APC SNMP IP");

	createValue(plug1, "plug_1", "state of the first plug", false, RTS2_VALUE_WRITABLE);
}
