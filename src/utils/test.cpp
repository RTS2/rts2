...
Rts2TestApp::run ()
{
  ...
  std::cout << "centrald day_horizont ret: " << conf->getDouble ("centrald",
								 ...
								 value);
  std::cout << " val " << value << std::endl;
  std::cout << "sbig blocked by C0: " << conf->blockDevice ("sbig",
							    "C0") << std::
    endl;
  std::cout << "sbig blocked by FSBIG: " << conf->blockDevice ("sbig",
							       "FSBIG") <<
    std::endl;
  std::cout << "C1 blocked by FSBIG: " << conf->blockDevice ("C1",
							     "FSBIG") << std::
    endl;
  std::cout << "PHOT blocked by FSBIG: " << conf->blockDevice ("PHOT",
							       "FSBIG") <<
    std::endl;
