...
FordConn::FordConn (const char *_devName, Rts2Block * _master, bSpeedT _baudSpeed, cSizeT _cSize, parityT _parity, int _vTime):Rts2ConnSerial (_devName, _master, _baudSpeed, _cSize, _parity)
{
