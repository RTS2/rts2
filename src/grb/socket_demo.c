 ...
 *		makes continuous periodic attempts to connect.
 *
 ...
 *		change these hardwire to addresses to your own address(es).
 *
 *  AUTHOR:
...
// HETE word and bit mask and shift definitions:
								 // Dimension in upper bits
#define H_MAXDIM_MASK   0xffff0000
#define H_MAXDIM_SHIFT  16		 // Dimension in upper bits
								 // Significance in lower bits
#define H_NSIG_MASK     0x0000ffff
#define H_NSIG_SHIFT    0		 // Significance in lower bits
								 // Dec in lower word
#define H_P_DEC_MASK    0x0000ffff
#define H_P_DEC_SHIFT   0		 // Dec in lower word
								 // RA in upper word
#define H_P_RA_MASK     0xffff0000
#define H_P_RA_SHIFT    16		 // RA in upper word
								 // Message number in low bits
#define H_SEQNUM_MASK   0xffff0000
...
#define H_STATERR_SHIFT 16		 // Statistical error in upper bits
								 // Systematic error in lower bits
#define H_SYSERR_MASK   0x0000ffff
...
#define H_WHO_TRIG_MASK 0x00000007
								 // WXM X LC (aka Virtue) value in slot 38
#define H_X_LC_SN       0xff000000
								 // WXM Y LC (aka Virtue) value in slot 38
#define H_Y_LC_SN       0x00ff0000
								 // WXM X (aka Goodness) value in slot 38
#define H_X_IMAGE_SN    0x0000ff00
								 // WXM Y (aka Goodness) value in slot 38
#define H_Y_IMAGE_SN    0x000000ff

// HETE H_TRIG_FLAGS bit_flags definitions:
								 // Did FREGATE trigger? 1=yes
#define H_GAMMA_TRIG    0x00000001
								 // Did WXM trigger?
#define H_WXM_TRIG      0x00000002
								 // Did SXC trigger?
#define H_SXC_TRIG      0x00000004
								 // Artificial trigger
#define H_ART_TRIG      0x00000008
								 // Possible GRB
#define H_POSS_GRB      0x00000010
								 // Definite GRB
#define H_DEF_GRB       0x00000020
								 // Definitely NOT a GRB
#define H_DEF_NOT_GRB   0x00000040
								 // S/c is in or near the SAA
#define H_NEAR_SAA      0x00000080
								 // Possible SGR
#define H_POSS_SGR      0x00000100
								 // Definite SGR
#define H_DEF_SGR       0x00000200
								 // Possible XRB
#define H_POSS_XRB      0x00000400
								 // Definite XRB
#define H_DEF_XRB       0x00000800
								 // FREGATE (gamma) data in this message
#define H_GAMMA_DATA    0x00001000
								 // WXM data in this message
#define H_WXM_DATA      0x00002000
								 // SXC data in this message
#define H_SXC_DATA      0x00004000
								 // OPT (s/c ACS) data in this message
#define H_OPT_DATA      0x00008000
								 // WXM position in this message
#define H_WXM_POS       0x00010000
								 // SXC position in this message
#define H_SXC_POS       0x00020000
								 // spare1
#define H_TRIG_spare1   0x000C0000
								 // Use H_WXM_S_N
#define H_USE_TRIG_SN   0x00400000
								 // spare2
#define H_TRIG_spare2   0x00800000
								 // Triggerred in the 1.5-12 keV band
#define H_SXC_EN_TRIG   0x01000000
								 // Triggerred in the 2-30 keV band
#define H_LOW_EN_TRIG   0x02000000
								 // Triggerred in the 6-120 keV band
#define H_MID_EN_TRIG   0x04000000
								 // Triggerred in the 25-400 keV band
#define H_HI_EN_TRIG    0x08000000
								 // Probable XRB
#define H_PROB_XRB      0x10000000
								 // Probable SGR
#define H_PROB_SGR      0x20000000
								 // Probable GRB
#define H_PROB_GRB      0x40000000
								 // spare3
#define H_TRIG_spare3   0x80000000
...
#define H_WXM_SXC_DIFF  0x00000002
								 // NSIG below a threshold
#define H_WXM_LOW_SIG   0x00000004
								 // NSIG below a threshold
#define H_SXC_LOW_SIG   0x00000008
								 // Gamma refined since FINAL
#define H_GAMMA_REFINED 0x00000010
								 // WXM refined since FINAL
#define H_WXM_REFINED   0x00000020
								 // SXC refined since FINAL
#define H_SXC_REFINED   0x00000040
								 // spare
#define H_POS_spare     0x00FFFFB0
								 // S/C Longitude
#define H_SC_LONG       0xFF000000

// HETE VALIDITY flag bit masks:
								 // Burst declared valid
#define H_BURST_VALID   0x00000001
...
#define H_VAL0x8_spare  0x00000008
								 // Emersion trigger
#define H_EMERGE_TRIG   0x00000010
								 // Known X-ray source
#define H_KNOWN_XRS     0x00000020
								 // No WXM or SXC position
#define H_NO_POSITION   0x00000040
								 // spare
#define H_VAL0x80_spare 0x00000080
								 // Bad burst: s/c & inst ops error
#define H_OPS_ERROR     0x00000100
								 // Bad burst: particles
#define H_PARTICLES     0x00000200
								 // Bad burst: bad flight location
#define H_BAD_FLT_LOC   0x00000400
								 // Bad burst: bad ground location
#define H_BAD_GND_LOC   0x00000800
								 // Bad burst: rising background
#define H_RISING_BACK   0x00001000
								 // Bad burst: poisson fluctuation trigger
#define H_POISSON_TRIG  0x00002000
								 // Good burst: but outside WSX/SXC FOV
#define H_OUTSIDE_FOV   0x00004000
								 // Good burst: IPN crossing match
#define H_IPN_CROSSING  0x00008000
								 // spare
#define H_VALID_spare   0x1FFFC000
...
#define H_INTERNAL_TEST 0x40000000
								 // GndAna shows this trigger to be non-GRB
#define H_NOT_A_BURST   0x80000000
...
#define I_TRIGNUM_SHIFT 0		 // Trigger number in low bits
								 // Message number in low bits
#define I_SEQNUM_MASK   0xffff0000
...
#define S_TRIGNUM_SHIFT 0		 // Trigger number in low bits
								 // Observation Segment number in upper bits
#define S_SEGNUM_MASK   0x000000ff
...
#define TYPE_ALEXIS_SRC         25
								 // XTE-PCA ToO Scheduled packet
#define TYPE_XTE_PCA_ALERT      26
								 // XTE-PCA GRB coords packet
#define TYPE_XTE_PCA_SRC        27
								 // XTE-ASM Alert packet
#define TYPE_XTE_ASM_ALERT      28
								 // XTE-ASM GRB coords packet
#define TYPE_XTE_ASM_SRC        29
//#define TYPE_COMPTEL_SRC		30  // COMPTEL GRB coords packet
								 // IPN_RAW GRB annulus coords packet
#define TYPE_IPN_RAW_SRC        31
								 // IPN_SEGment GRB annulus segment coords pkt
#define TYPE_IPN_SEG_SRC        32
								 // SAX-WFC Alert packet
#define TYPE_SAX_WFC_ALERT      33
								 // SAX-WFC GRB coords packet
#define TYPE_SAX_WFC_SRC        34
								 // SAX-NFI Alert packet
#define TYPE_SAX_NFI_ALERT      35
								 // SAX-NFI GRB coords packet
#define TYPE_SAX_NFI_SRC        36
								 // XTE-ASM TRANSIENT coords packet
#define TYPE_XTE_ASM_TRANS      37
								 // spare
#define TYPE_spare_SRC          38
								 // IPN_POSition coords packet
#define TYPE_IPN_POS_SRC        39
								 // HETE S/C_Alert packet
#define TYPE_HETE_ALERT_SRC     40
								 // HETE S/C_Update packet
#define TYPE_HETE_UPDATE_SRC    41
								 // HETE S/C_Last packet
#define TYPE_HETE_FINAL_SRC     42
								 // HETE Ground Analysis packet
#define TYPE_HETE_GNDANA_SRC    43
								 // HETE Test packet
#define TYPE_HETE_TEST          44
								 // GRB Counterpart coords packet
#define TYPE_GRB_CNTRPART_SRC   45
...
#define TYPE_INTEGRAL_OFFLINE_SRC   55
								 // SNEWS Position/Test message
#define TYPE_SNEWS_POS_SRC          57
...
#define TYPE_SWIFT_XRT_IMAGE_PROC_SRC    78
								 // SWIFT UVOT Image processed mesg (aka DarkBurst, aka GeNie)
#define TYPE_SWIFT_UVOT_IMAGE_PROC_SRC   79
								 // SWIFT UVOT Source List processed message (aka FindChart)
...
char            *argv[];		 // Pointers to all the cmdline arguments
{
	...
	long            lbuf[SIZ_PKT];
								 // Count number of bad pkt types received
	int             bad_type_cnt=0;
	#ifdef LINUXPC
	int             i;			 // General loop variable
								 // Swap space for different endian platforms
	static long     nbuf[SIZ_PKT];
	...
	port = atoi(argv[1]);		 // Get the cmdline value for the port number
								 ...
								 // Open for appending
	if((lg = fopen("socket_demo.log", "a")) == NULL)
	{
		...
		else
		{
			...
			if((bytes=read(inetsd,(char *)nbuf,sizeof(nbuf))) > 0)
			{
				...
				if((bytes=read(inetsd,(char *)lbuf,sizeof(lbuf))) > 0)
				{
					...
					{
						case TYPE_IM_ALIVE:
								 // Dump pkt contents to the screen
							pr_imalive(lbuf,stdout);
								 // Dump pkt contents to the logfile
							pr_imalive(lbuf,lg);
							last_here_sod = here_sod;
							last_imalive_sod = lbuf[PKT_SOD]/100.0;
								 // Pass time of latest imalive
							chk_imalive(1,tloc);
							break;
						...
						case TYPE_TEST_COORDS:
								 // Special Bradford Test Coords
						case TYPE_BRAD_COORDS:
								 // Dump pkt contents to the screen
							pr_packet(lbuf,stdout);
								 // Dump pkt contents to the logfile
							pr_packet(lbuf,lg);
							break;
								 // ALEXIS extreme-UV transients
						case TYPE_ALEXIS_SRC:
						...
						case TYPE_XTE_ASM_TRANS:
							...
							break;
								 // Not implimented for sockets yet
						case TYPE_IPN_SEG_SRC:
						...
						case TYPE_SWIFT_UVOT_SLIST_SRC:
							...
							// so they will not be duplicated here in this switch().
								 ...
								 // 81  // SWIFT UVOT Position message
	...
	unsigned short      type;	 // Type of socket connection
	{
		int                 sock;// The connected sock descriptor
								 // The offerred sock descriptor
		int                 sd=-1;
		int                 temp;// Dummy variable
								 // Socket address length + 2
		int                 saddrlen;
		char                on=1;// Flag for nonblocking I/O
								 // Socket structure for UNIX
	...
	FILE    *s;					 /* Stream to print it to */
	{
		...
		fprintf(s,"on a %.3f sec timescale\n", (float)lbuf[H_WXM_TSCALE]/1000.0);
								 /* Check for XG data and parse */
		if(lbuf[H_TRIG_FLAGS] & H_WXM_DATA)
		...
		fprintf(s,"   BURST_DEC:   %+7.3fd  (current)\n", lbuf[BURST_DEC]/10000.0);
								 ...
								 /* Flag says that WXM pos is available */
		if(lbuf[H_TRIG_FLAGS] & H_WXM_POS)
		...
		fprintf(s,"   WXM_LC_SN:       X= %.1f Y= %.1f [sig/noise]\n",
			wxm_x_lc_sn/10.0, wxm_y_lc_sn/10.0);
								 ...
								 /* Flag says that SXC pos is available */
		if(lbuf[H_TRIG_FLAGS] & H_SXC_POS)
		...
		if(lbuf[H_TRIG_FLAGS] & H_NEAR_SAA)
			fprintf(s,"   COMMENT:   S/c is in or near the SAA.\n");
								 ...
								 /* Flag says that SXC position is available */
		if(lbuf[H_TRIG_FLAGS] & H_WXM_POS)
	...
	FILE        *s;				 /* Stream to print it to */
	{
		...
		if(lbuf[TRIGGER_ID] & 0x00000020)
			fprintf(s,"   This is a RETRACTION of a previous notice that identified this as a GRB -- it is NOT a GRB.\n");
								 // Only if this got a copy of BAT_POS_ACK soln_status
		if(lbuf[MISC] & (0x1<<24))
	...
	FILE        *s;				 /* Stream to print it to */
	{
		...
		fprintf(s,"   Error=    %.1f [arcsec, radius, statistical only]\n",
			(float)3600.0*lbuf[BURST_ERROR]/10000.0);
								 //this are arbitrary units
		fprintf(s,"   Flux=     %.2f [arb]\n", lbuf[BURST_INTEN]/100.0);
								 // sqrt(num_pixels_w_photons)
		fprintf(s,"   Signif=   %.2f [sigma]\n", lbuf[21]/100.0);
	...
	{
								 // Timestamp of last imalive received
		static time_t   last_ctloc;
								 // State of checking engine
		static int      imalive_state = 0;
		...
		switch(imalive_state)
		{
			...
			case 1:
				...
				{
								 /* Get system time for mesg timestamp */
					time(&nowtime);
