...
int
ConstTarget::getRST (struct ln_lnlat_posn *observer, struct ln_rst_time *rst,
		     double JD)
{
...
int
EllTarget::getRST (struct ln_lnlat_posn *observer, struct ln_rst_time *rst,
		   double JD)
{
...
int
ParTarget::getRST (struct ln_lnlat_posn *observer, struct ln_rst_time *rst,
		   double JD)
{
