...
echo "./u_acquire.py --base-path $BASE_DIRECTORY --do-not-use-rts2 --fetch-dss-image --with-meteo --mode-continues --level DEBUG"
#
./u_acquire.py --base-path $BASE_DIRECTORY --do-not-use-rts2 --fetch-dss-image --with-meteo --mode-continues --level DEBUG --toconsole
#
