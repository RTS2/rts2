...
class Transformation(object):
  ...
  def LN_EQ_to_AltAz(self,ra=None,dec=None,ln_pressure_qfe=None,ln_temperature=None,ln_humidity=None,obstime=None,apparent=False):
    ...
    if apparent:
      ...
      ln.ln_get_equ_aber(byref(ln_pos_eq_pr), c_double(obstime.jd), byref(ln_pos_eq_ab))
  ...
  def LN_ICRS_to_GCRS(self,ra=None,dec=None,ln_pressure_qfe=None,ln_temperature=None,ln_humidity=None,obstime=None,apparent=False):
    ...
    ln.ln_get_equ_prec(byref(ln_pos_eq), c_double(obstime.jd), byref(ln_pos_eq_pr))
    ln.ln_get_equ_aber(byref(ln_pos_eq_pr), c_double(obstime.jd), byref(ln_pos_eq_ab))
    ##ln.ln_get_equ_prec(byref(ln_pos_eq), c_double(obstime.jd), byref(ln_pos_eq_ab))
    ...
    gcrs=SkyCoord(ra=ra.radian,dec=dec.radian,unit=(u.radian,u.radian),frame='cirs',location=self.obs,obstime=obstime,obswl=0.5*u.micron, pressure=ln_pressure_qfe*u.hPa,temperature=ln_temperature*u.deg_C,relative_humidity=ln_humidity)

    return gcrs


  def LN_GCRS_to_AltAz(self,ra=None,dec=None,ln_pressure_qfe=None,ln_temperature=None,ln_humidity=None,obstime=None,apparent=False):
    # use ev. other refraction methods
    ln_pos_eq.ra=ra
    ln_pos_eq.dec=dec
    if apparent:
