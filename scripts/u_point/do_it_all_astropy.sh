...
# 2016-11-14, wildi.markus@bluewin.ch
#
# Demonstrate u_point in simulation mode without RTS2.
#
# In this script u_point.py uses astropy to transform the coordinates.
# (The only difference to do_it_all_libnova.sh is  --astropy on the
# last line)
#
...
#
./u_point.py --base-path $BASE_DIRECTORY --astropy --mount-data  u_point_positions_sxtr.anl --plot --level DEBUG --toconsole
